...
```
p7 <- ggplot(counts_2020.2, aes(x=predators_total, y=predated_total)) +
...
ggsave(p7, filename="predation_regression_2020.pdf", devic=cairo_pdf, width=5, height=3.33, units="in")
```
